<?php
/**
 * Configuración Kommo / WhatsApp Business.
 * Secretos en config/kommo.local.php (añadir a .gitignore).
 * NO commitear tokens reales a repos públicos.
 */

// Primero secretos locales (si existen)
...
if (!defined('KOMMO_SUBDOMAIN')) {
    define('KOMMO_SUBDOMAIN', 'tecnologiatysbpocom');
}
...
if (!defined('KOMMO_WEBHOOK_URL')) {
    define('KOMMO_WEBHOOK_URL', 'https://bad4-201-245-200-242.ngrok-free.app/emer_cobranza/wa_webhook.php');
}
...
/**
 * True con subdomain + token long-lived.
 * channel_* es del canal WhatsApp/Chats (aún puede faltar).
 */
function kommoEnabled(): bool {
    return KOMMO_SUBDOMAIN !== ''
