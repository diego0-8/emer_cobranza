...
$cliente = $cliente ?? [];
$estadisticasFacturas = $estadisticasFacturas ?? ($estadisticasObligaciones ?? []);
$tieneTelefono = $tieneTelefono ?? false;
...
<head>
    ...
    <?php require_once __DIR__ . '/shared_navbar.php'; renderPageHead((string)($page_title ?? 'Gestionar Cliente')); ?>
...
// #endregion
    ...
    <script>
        ...
        function guardarTipificacion() {
            ...
            // Enviar call_id del softphone (si existe) para enlazar gestión <-> llamada.
            try {
    ...
    <script>
        ...
        async function llamarDesdeWebRTC(numero) {
            ...
            try {
                // Contexto para call_log (enlazar llamada con este cliente)
                if (typeof window.webrtcSoftphone.setCallContext === 'function') {
                    window.webrtcSoftphone.setCallContext({
                        cliente_id: <?php echo (int)($cliente['id'] ?? 0); ?>,
