...
$page_title = $page_title ?? 'Gestión del Asesor';
if (!isset($asesor) || !is_array($asesor)) {
    $asesor = [];
}
$clientes = isset($clientes) && is_array($clientes) ? $clientes : [];
$gestiones = isset($gestiones) && is_array($gestiones) ? $gestiones : [];
$metricas = isset($metricas) && is_array($metricas) ? $metricas : [];
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <?php require_once __DIR__ . '/shared_navbar.php'; renderPageHead($page_title ?? 'Gestión del Asesor'); ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <button class="btn btn-primary" onclick="mostrarDetallesAsesor(<?php echo (int)($asesor['id'] ?? 0); ?>)">
                        📊 Ver Modal Detallado
                    </button>
                </div>
            </div>
