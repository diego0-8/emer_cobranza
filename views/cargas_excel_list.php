...
<body>
    ...
    <div class="container">
        ...
        <?php 
        /** @var array<int, array<string, mixed>> $cargas Bases del coordinador (inyectado por CoordinadorController::listCargas) */
        if (!isset($cargas) || !is_array($cargas)) {
            $cargas = [];
        }
                    ...
                    <div class="carga-item">
                        <div class="carga-header">
                            ...
                            <div class="carga-stats">
                                <div class="stat-item">
                                    <span class="stat-number"><?php echo (int)($carga['total_clientes'] ?? 0); ?></span>
                                    <span class="stat-label">Clientes</span>
                                </div>
                                <div class="stat-item">
                                    <span class="stat-number"><?php echo (int)($carga['total_obligaciones'] ?? 0); ?></span>
                                    <span class="stat-label">Obligaciones</span>
                                </div>
                                <div class="stat-item">
                                    <span class="stat-number"><?php echo (int)($carga['clientes_asignados'] ?? 0); ?></span>
