...
$clientes_vista = isset($clientes_vista) && is_array($clientes_vista) ? $clientes_vista : [];
$total_clientes = isset($total_clientes) ? (int) $total_clientes : 0;
$carga = isset($carga) && is_array($carga) ? $carga : [];
$carga_id = isset($carga_id) ? (int) $carga_id : (int) ($carga['id'] ?? 0);
?>
<!DOCTYPE html>
<html lang="es">
<head>
