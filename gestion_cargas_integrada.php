    ...
    <div class="container">
        ...
        <div class="alert alert-info" style="margin-top: 12px;">
            ...
            <div style="margin-top: 6px; font-size: 0.95em;">
                <strong>Obligatorias en el CSV:</strong> <code>cedula</code> y <code>numero_factura</code> (o encabezados que contengan esas palabras, p. ej. <em>NÚMERO FACTURA</em>).
                El resto es opcional y se mapea a las tablas <code>clientes</code> y <code>obligaciones</code> como en la base de datos.
            </div>
        </div>
        ...
        <div class="instructivo">
            ...
            <p>La misma <strong>cédula</strong> puede existir en varias bases: en <code>clientes</code> se distingue por <code>base_id</code> (cada base es independiente). Obligatorios en el archivo: <strong>cedula</strong> y <strong>numero_factura</strong>. Los demás campos coinciden con las columnas de la BD para facilitar el mapeo automático.</p>
            ...
            <div class="instructivo-content">
                <div class="instructivo-section">
                    <h4>
                        ...
                        Campos obligatorios (CSV)
                    </h4>
                    <ol>
                        <li><span class="campo-obligatorio">cedula</span> → columna <code>clientes.cedula</code> (texto, sin puntos si es posible)</li>
                        <li><span class="campo-obligatorio">numero_factura</span> → <code>obligaciones.numero_factura</code> (una fila CSV = una obligación; varias filas con la misma cédula = varias facturas)</li>
                    </ol>
                    
                    <h4 style="margin-top: 20px;">
                        <i class="fas fa-plus-circle"></i>
                        Tabla <code>clientes</code> (opcional — se aplican valores por defecto si faltan)
                    </h4>
                    <ul>
                        <li><span class="campo-opcional">nombre</span> → <code>nombre</code> (si falta: <em>SIN NOMBRE</em>)</li>
                        <li><span class="campo-opcional">email</span> → <code>email</code> (si falta: placeholder interno)</li>
                        <li><span class="campo-opcional">ciudad</span> → <code>ciudad</code></li>
                        <li><span class="campo-opcional">telefono</span> / <strong>tel1</strong>…<strong>tel10</strong> → <code>tel1</code>…<code>tel10</code> (vacío permitido en BD)</li>
                        <li><span class="campo-opcional">telefono2</span>, <span class="campo-opcional">telefonos_3</span> → se distribuyen en <code>tel2</code>, <code>tel3</code>, etc.</li>
                    </ul>
                    
                    <h4 style="margin-top: 20px;">
                        <i class="fas fa-dollar-sign"></i>
                        Tabla <code>obligaciones</code> (opcional — defaults: rmt/contrato 0, franja N/A)
                    </h4>
                    <ul>
                        <li><span class="campo-financiero">rmt</span> → <code>rmt</code></li>
                        <li><span class="campo-financiero">numero_contrato</span> → <code>numero_contrato</code></li>
                        <li><span class="campo-financiero">saldo</span> → <code>saldo</code></li>
                        <li><span class="campo-financiero">dias_mora</span> o <strong>dias en mora</strong> → <code>dias_mora</code></li>
                        <li><span class="campo-financiero">franja</span> → <code>franja</code></li>
                    </ul>
                </div>
                ...
                <div class="instructivo-section">
                    ...
                    <div class="ejemplo-csv">
                        <div class="header">cedula;nombre;email;ciudad;tel1;tel2;rmt;numero_factura;numero_contrato;saldo;dias_mora;franja</div>
                        <div class="row">41377716;MARTHA CAICEDO;martha@mail.com;CALI;2261958;3002715514;1282;5363187;01-18966;41498;126;BLOQUEADO</div>
                        <div class="row">27240803;LIGIA RUEDA;ligia@mail.com;BOGOTA;2141488;;1668;5460935;01-20628;1054469;102;ESPERA</div>
                    </div>
        ...
        <div class="upload-options">
            <div class="upload-option existente" onclick="selectUploadOption('existente')">
                ...
                <p>Actualiza datos de clientes y obligaciones en la base elegida. La <strong>cédula no se modifica</strong>; nombre, contacto, ciudad, teléfonos y columnas de obligación sí. Las facturas del CSV reemplazan el conjunto previo del cliente en esa base.</p>
            </div>
